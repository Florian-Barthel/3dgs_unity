...
{
    [BurstCompile]
    public class GaussianSplatAssetCreatorFolder3DIL : EditorWindow
    {
        ...
        Dictionary<string, string> perpetratorDict = new Dictionary<string, string>();
 

        [MenuItem("3DGS/Create from Folder 3DIL")]
        public static void Init()
        {
            var window = GetWindowWithRect<GaussianSplatAssetCreatorFolder3DIL>(new Rect(50, 50, 360, 340), false, "3DIL Splat Creator", true);
        ...
        void Awake()
        {
            ...
            perpetratorDict.Add("142", "C0");
            perpetratorDict.Add("151", "A0");
            perpetratorDict.Add("145", "C2");
            perpetratorDict.Add("153", "A2");
            perpetratorDict.Add("143", "C1");
            perpetratorDict.Add("152", "A1");
            perpetratorDict.Add("147", "C3");
            perpetratorDict.Add("148", "A3");       
        }
        ...
        unsafe void CreateAsset(String ply_file)
        {
            ...
            Directory.CreateDirectory(Path.Combine(m_OutputFolder, "3DGS_assets/A"));
            Directory.CreateDirectory(Path.Combine(m_OutputFolder, "3DGS_assets/perpetrator"));

            Directory.CreateDirectory(Path.Combine(m_OutputFolder, "3DGS_prefabs"));
            Directory.CreateDirectory(Path.Combine(m_OutputFolder, "3DGS_prefabs/rest"));
            Directory.CreateDirectory(Path.Combine(m_OutputFolder, "3DGS_prefabs/C"));
            ...
            PrefabUtility.SaveAsPrefabAsset(gaussianPrefab, prefabPath);
