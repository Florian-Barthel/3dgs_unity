...
namespace GaussianSplatting.Runtime
{
    public class GaussianSplatRenderSystem
    {
        ...
        public Material SortAndRenderSplats(Camera cam, CommandBuffer cmb)
        {
            ...
            {
                var gs = kvp.Item1;
                if (!gs.CompareTag(cam.tag) && (cam.cameraType != CameraType.SceneView))
                    continue;
                gs.EnsureMaterials();
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        public void SetAsset(GaussianSplatAsset asset)
        {
            m_Asset = asset;
        }
        ...
        void SetAssetDataOnCS(CommandBuffer cmb, KernelIndices kernel)
        {
            ...
            uint format = (uint)m_Asset.posFormat | ((uint)m_Asset.scaleFormat << 8);
        ...
        public void EditSetSplatCount(int newSplatCount)
        {
            ...
            EditCopySplats(transform, newPosData, newOtherData, newColorData, newEditDeleted, newSplatCount, 0, 0, m_SplatCount);
        ...
        public void EditCopySplatsInto(GaussianSplatRenderer dst, int copySrcStartIndex, int copyDstStartIndex, int copyCount)
        {
            EditCopySplats(
                dst.transform,
                dst.m_GpuPosData, dst.m_GpuOtherData, dst.m_GpuColorData, dst.m_GpuEditDeleted,
                dst.splatCount,
